(function(global){
  ...
  var applyChartConfiguration = global.applyChartConfiguration = function(prefix, container, instance, immediates){
  ...
  global.getChartPropertyValues = function(container){
    ...
    for (i=0; i<l; i++){
      ...
      if(name){
        vals[name] = attr.nodeValue;
      }
    }
    return vals;
  };
  
  global.getChartProperties = function(container){
    var controller = container.controller?container.controller:container;
    var chart = controller.chart?controller.chart:controller;
  ...
  global.setChartProperty = function(container, propertyName, value, data){
    var controller = container.controller;
    var prefix = controller.dataAttributePrefix || 'chart';
    console.log('data-'+prefix+'-'+propertyName, container);
  ...
  global.getChartProperty = function(container, propertyName){
    var controller = container.controller;
